...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    ...
    config.add_show_field 'ua_update_status', :label=>'Update Status (from matchissn'
    config.add_show_field 'ua_sfx_date_statement', :label=>'Summary of Holdings (from SFX)'
    config.add_show_field 'ua_sirsi_date_statement', :label=>'Summary of Holdings (from Sirsi)'
